...
@section('content')
    <div class="hero mt-4">
        <h1 class="fw-bold mb-0">Create Backup Schedule</h1>
    </div>

    <div class="backup-card mt-4">
        <div class="p-4">
            <form method="POST" action="{{ route('backup-schedules.store') }}">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="cron_expression" class="form-control" required value="{{ old('cron_expression', '0 0 * * *') }}">
                        <small class="text-muted">e.g. 0 0 * * * (daily at midnight)</small>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Timezone</label>
                        <input type="text" name="timezone" class="form-control" required value="{{ old('timezone', 'UTC') }}">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-check mt-4">
                            <input type="checkbox" name="auto_cleanup" value="1" class="form-check-input" id="autoCleanup" {{ old('auto_cleanup', true) ? 'checked' : '' }}>
                            <label class="form-check-label" for="autoCleanup">Auto Cleanup</label>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-check mt-4">
                            <input type="checkbox" name="auto_verify" value="1" class="form-check-input" id="autoVerify" {{ old('auto_verify', true) ? 'checked' : '' }}>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary"><i class="bi bi-check-circle me-1"></i> Create Schedule</button>
